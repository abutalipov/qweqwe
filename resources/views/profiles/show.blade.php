                    ...
                    <ul class="list-me list-clear">
                        ...
                        @if($user->profile->city or $user->profile->country)
                            <li class="list-me__item">
                                ...
                                <div class="list-me__val">{{$user->profile->city}} ({{$user->profile->country}})</div>
                            </li>
                        @endif
                    </ul>
                    <div class="about-me__more type-h3" id="about-more">See more</div>
                    <ul class="list-me list-clear list-me_hidden">
                        @if($user->email)<li class="list-me__item">
                        ...
                        <div class="rating-skill__item">
                            ...
                            <div class="rating-skill__col-total">
                                <ul class="about-rating__list list-clear type-h3">
                                    ...
                                    <li class="about-rating__list-item c-g">{{$user->profile->country}}<span class="about-rating__accent c-a">7 th</span></li>
                                    <li class="about-rating__list-item c-g">{{$user->profile->city}}<span class="about-rating__accent c-a">2 nd</span></li>                                    
                                </ul>
                            </div>
                        </div>
                        @endforeach
...
<div class="write-post">
    ...
    <textarea class="write-post__input type-h4_m" id="writepost" name="content" placeholder="Anything to share?"></textarea>
            ...
            <div class="post-item container-mobile">
                <div class="post-author">
                    <div class="post-author__col-info">
                        <div class="post-author__avatar"><img src="{{$wall->user->profile->avatar}}" alt=""></div>
                ...
                <div class="post-comments">
                    ...
                    @foreach($wall->children as $child) 
                        <div class="post-comments__item"><a class="post-comments__avatar" href="#"><img src="{{$child->user->profile->avatar}}" alt=""></a>
                            <div class="post-comments__content">
                                <div class="post-comments__info"><a class="post-comments__title type-h2 type-h2_m c-a" href="#">{{$child->user->renderName}}</a>
